...
public class TypeName implements Comparable<TypeName> {
  ...
  public TypeName(Class<?> clazz) {
	...
	this.typeSimpleNameWithOuterClassNotSeparatedByDots = ClassUtil.getSimpleNameWithOuterClassNotSeparatedByDots(
			clazz);
  ...
  public boolean isDate() {
	return DATE.equals(typeSimpleName) && JAVA_UTIL_PACKAGE.equals(packageName);
  }
  ...
  public boolean isBoolean() {
	return (BOOLEAN.equals(typeSimpleName) && isEmpty(packageName)) || (typeSimpleName.equals("Boolean")
	                                                                    && JAVA_LANG_PACKAGE.equals(packageName));
  }
